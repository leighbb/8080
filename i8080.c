...
static inline void i8080_wb(i8080* const c, const uint16_t addr, const uint8_t val) {
...
static inline void i8080_ww(i8080* const c, const uint16_t addr, const uint16_t val) {
...
static inline void i8080_sub(i8080* const c, uint8_t* const reg, uint8_t val, bool cy) {
